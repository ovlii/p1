   ...
   <form name="contactform" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
      <table width="450px">
         ...
         <tr>
            ...
            <td valign="top">
               <input  type="text" name="dateofbirth" id="dateofbirth" maxlength="30" size="30"/>
            </td>
         </tr>         
         <tr>
            <td valign="top">
            ...
            <td valign="top">
               <textarea  name="comments" id="comments" cols="25" rows="6"></textarea>
            </td>
         </tr>
         <tr>
            <td colspan="2" style="text-align:center">
               <input type="submit" name="submit_button" value="Submit"/>   <a href="http://www.freecontactform.com/email_form.php">Email Form</a>
            </td>
         </tr>
      </table>
   </form>
...
if(isset($_POST['email'])) {
    ...
    $email_to = "annrapid@gmail.com";
    $email_subject = "Contact Us - Annrapid Inc.";
